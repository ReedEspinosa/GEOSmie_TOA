...
./runoptics.py --dest x --namelist input_files/gocart/namelists/geos_nodust.txt
./runbands.py --dest x --namelist input_files/gocart/namelists/geos_nodust_bands.txt
